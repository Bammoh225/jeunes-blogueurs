...
router.post('/', blogueursController.inscrire);
...
),                                                         blogueursController.modifier);
router.patch('/:id/statut', authMiddleware, managementRoles, blogueursController.changerStatut);
